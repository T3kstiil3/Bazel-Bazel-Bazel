...
* Duree d'un build et des tests sont trop long pour avoir un feedback rapidement. 
* Inner source 
* Problème connu
* En effet, des grosses sociétes se sont penchés sur le sujet, et notamment Google qui propose ...  
* Bonne idée de parler de Qima
